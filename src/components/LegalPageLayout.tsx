...
const iconColors = {
  ...
  faq: 'from-purple-500 to-violet-600',
  refund: 'from-orange-500 to-red-500',
};
      ...
      <div className={`bg-gradient-to-br ${iconColors[icon]} text-white py-12 md:py-16`}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <button
            ...
            className="flex items-center gap-2 text-white/80 hover:text-white transition mb-6 text-sm"
          >
